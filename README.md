...
* Note: this JRuby JAXB example is based on the Ort, Mehta JAXB example
...
<books>
    ...
    <book itemId="309">
        ...
        <promotion>
            <Discount>$5 Rebate</Discount>
        </promotion>
    </book>
    <book itemId="310">
        <name>JAXB Tutorial</name>
        <ISBN>0</ISBN>
        <authors>
            <authorName>Ed Ort</authorName>
            <authorName>Bhakti Mehta</authorName>
        </authors>
        <promotion>
            <None>Free article</None>
        </promotion>
    </book>
</books>
```
